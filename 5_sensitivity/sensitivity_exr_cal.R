...
if (heckman == "heckman") {
  ...
  vcv <- fread('/project/cil/home_dirs/maiqi/repos/labor-code-release-2020/disutility_ext/heckman_vars_covars.csv')
  ...
  if (interacted == "interacted") {
    ...
    #<<<<<<< HEAD
    dfb_original <- dfb
    coefs <- fread('/project/cil/home_dirs/maiqi/repos/labor-code-release-2020/disutility_ext/interacted_coefs.csv')
    #=======
    dfb <- fread("/project/cil/sacagawea_shares/gcp/climate/_spatial_data/impactregions/weather_data/csv_daily/GMDF_tmax_temp_and_spline_avg_year.csv")
    ...
    vcv <- fread('/project/cil/home_dirs/maiqi/repos/labor-code-release-2020/disutility_ext/interacted_vars_covars.csv')
