...
plot_impact_timeseries = function(rcp, ssp, iam, adapt, risk, region, aggregation="", suffix="", output_folder = glue("{DIR_FIG}/mc_correct_rebasing_for_integration/")){
...
plot_impact_timeseries(rcp="rcp45",ssp="SSP3",iam="high",
  adapt="incadapt",risk="allrisk",region="global",aggregation = "-wage-aggregated")
