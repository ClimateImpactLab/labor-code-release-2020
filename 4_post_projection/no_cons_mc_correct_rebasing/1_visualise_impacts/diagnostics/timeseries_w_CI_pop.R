...
plot_ts_fig_2C = function(output, DB_data){
  ...
  ggtitle(paste0("high", "-rcp85","-SSP3", "-fulluncertainty MC minutes")) 
  print(paste0(output, "/mc/diagnostics/fig", "_SSP3_fulluncertainty_time_series_pop.pdf"))
  ggsave(paste0(output, "/mc/diagnostics/fig", "_SSP3_fulluncertainty_time_series_pop.pdf"), p)
  return(p)
}
