...
get_df_list_fig_2C = function(DB_data){
  ...
  load_df = function(rcp, adapt){
    ...
    df= read_csv(glue('{DB_data}/projection_outputs/extracted_data_mc_correct_rebasing_for_integration/SSP3-{rcp}_high_allrisk_{adapt}-gdp-aggregated_global_timeseries.csv'))
