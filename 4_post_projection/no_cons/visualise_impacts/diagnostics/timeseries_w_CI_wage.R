...
plot_ts_fig_2C = function(output, DB_data){
  ...
  print(paste0(output, "/mc/diagnostics/fig", "_SSP3_fulluncertainty_time_series_wage.pdf"))
  ggsave(paste0(output, "/mc/diagnostics/fig", "_SSP3_fulluncertainty_time_series_wage.pdf"), p)
  return(p)
}
