...
data_root <- "/mnt/CIL_labor/outreach/UN/"
...
# spot check values
input = fread("/shares/gcp/estimation/labor/code_release_int_data/projection_outputs/outreach/SSP3-rcp45_low_lowrisk_fulladapt.csv")
output = fread("//mnt/CIL_labor/outreach/UN/impact_regions/rcp45/SSP3/unit_lowrisk_impacts_mins_worked_geography_impact_regions_years_all_rcp45_SSP3_quantiles_q17.csv")
input %>% filter(region == "ABW", year == 2020)
output %>% filter(Region_ID == "ABW")
