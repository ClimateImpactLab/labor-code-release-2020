...
quantiles_command = paste0("python -u quantiles.py ",
	...
	"--suffix=_damage_function_valuescsv_wage --only-ssp=SSP3 --region=global ",
...
quantiles_command = paste0("python -u quantiles.py ",
	...
	"2_extract_projection_outputs/extraction_configs/",
	"damage_function_valuescsv.yml ",
	"--suffix=_damage_function_valuescsv_popweights --only-ssp=SSP3 --region=global ",
...
quantiles_command = paste0("python -u quantiles.py ",
	"/home/liruixue/repos/labor-code-release-2020/3_projection/",
	"2_extract_projection_outputs/extraction_configs/",
	"damage_function_valuescsv.yml --only-ssp=SSP3 --region=global ",
