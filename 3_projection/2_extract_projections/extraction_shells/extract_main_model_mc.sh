...
config=/project/cil/home_dirs/egrenier/repos/labor-code-release-2020/3_projection/2_extract_projections/extraction_configs/extract_main_model_mc.yml
            ...
            for v in "${varlist[@]}" ; do
                for scn in "${scnlist[@]}" ; do
                    for suffix_aggregated in "${suffix_list[@]}" ; do
                        ...
                        output=${output}/${basename}/${rcp}/${iam}/${ssp}
                        mkdir -p ${output}
