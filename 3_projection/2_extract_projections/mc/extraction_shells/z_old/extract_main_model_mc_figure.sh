...
output="/project/cil/gcp/outputs/labor/impacts-woodwork/montecarlo/test"
...
aggregated="TRUE" 
levels="FALSE"
varlist=( highriskimpacts lowriskimpacts ) # rebased highriskimpacts lowriskimpacts clip highrisk allrisk 
