...
#'                The LR curve is grounded at the global LR optimum T_opt_LR and 
#'                floored at zero (losses only). d_h is clipped up to d_l: 
#'                if HR is no worse than LR, hedonic value is 0
#'
#==============================================================================#
