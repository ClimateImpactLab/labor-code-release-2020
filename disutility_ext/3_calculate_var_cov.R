...
if (heckman == "heckman") {
 ...
 {v_t0    <- as.vector(vcv[1+14,1+14])
  ...
  numbers <- c(V_LR_T, V_LR_TS, V_HR_T, V_HR_TS,C_LR_T_LR_TS, C_LR_T_HR_TS, C_LR_T_HR_T,C_LR_TS_HR_T,C_LR_TS_HR_TS,C_HR_T_HR_TS)
  names <- c("V_LR_T", "V_LR_TS", "V_HR_T", "V_HR_TS","C_LR_T_LR_TS", "C_LR_T_HR_TS", "C_LR_T_HR_T","C_LR_TS_HR_T","C_LR_TS_HR_TS","C_HR_T_HR_TS")
  
  out <- cbind(names, numbers)
  #fwrite(out, '~/repos/labor-code-release-2020/disutility_ext/original_vars_covars.csv')
  fwrite(out, '~/repos/labor-code-release-2020/disutility_ext/heckman_vars_covars.csv')
  ...
  if (interacted == "interacted") {
    ...
    numbers <- c(V_LR_T, V_LR_TS, V_HR_T, V_HR_T_G, V_HR_TS, V_HR_TS_G, C_HR_TS_HR_TS_G, C_HR_T_G_HR_TS_G, C_HR_T_HR_TS_G, C_HR_T_HR_T_G, C_HR_T_G_HR_TS, C_LR_TS_HR_TS_G, C_LR_T_HR_T_G, C_LR_T_LR_TS, C_LR_T_HR_TS, C_LR_T_HR_T,C_LR_TS_HR_T,C_LR_TS_HR_TS,C_HR_T_HR_TS)
    names <- c("V_LR_T","V_LR_TS","V_HR_T" ,"V_HR_T_G" ,"V_HR_TS","V_HR_TS_G","C_HR_TS_HR_TS_G", "C_HR_T_G_HR_TS_G","C_HR_T_HR_TS_G","C_HR_T_HR_T_G","C_HR_T_G_HR_TS","C_LR_TS_HR_TS_G", "C_LR_T_HR_T_G","C_LR_T_LR_TS", "C_LR_T_HR_TS", "C_LR_T_HR_T","C_LR_TS_HR_T", "C_LR_TS_HR_TS", "C_HR_T_HR_TS")
    
    out <- cbind(names, numbers)
    fwrite(out, '~/repos/labor-code-release-2020/disutility_ext/interacted_vars_covars.csv')
