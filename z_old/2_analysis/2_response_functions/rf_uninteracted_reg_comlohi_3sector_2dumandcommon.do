...
foreach row_values in full_response table_values {
    ...
    local comm_ster "`reg_folder'/uninteracted_reg_common_2025_manuf.ster"
    ...
    local by_risk_ster "`reg_folder'/uninteracted_reg_by_risk_2025_manuf.ster"
    ...
    // 5) Export results
    local rf_name "`rf_folder'/uninteracted_reg_comlohi_`row_values'_2025_manuhh.csv"
