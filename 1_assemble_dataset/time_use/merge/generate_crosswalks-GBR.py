...
# *^%$%%^& Deduplicate by region_code while keeping the first occurrence
cw["GBR"] = cw["GBR"].sort_values("region_code")  # optional but clean
cw["GBR"] = cw["GBR"].drop_duplicates(subset=["region_code"], keep="first")
