*-------------------------------------------------------------------------------
* uninteracted_reg_comlohi_3sector.do
*-------------------------------------------------------------------------------
* PURPOSE
*   Estimate the main 3-sector labor-temperature regressions
*
* STEPS
...
log using "${DIR_OUTPUT}/logs/uninteracted_reg_comlohi_3sector.log", replace text
...
foreach reg of local reg_list {
    ...
    local ster_name "`reg_folder'/uninteracted_reg_`reg'_2026_272841_sector.ster"
    local spec_desc "Main 3-sector model; knots 27 28 41; fe=$`fe'; spec=`reg'; weight=`weight'"
