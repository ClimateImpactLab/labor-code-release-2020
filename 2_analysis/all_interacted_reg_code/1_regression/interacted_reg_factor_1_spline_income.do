...
gl dataset      "/project/cil/battuta_shares/gcp/estimation/labor/code_release_int_data/regression_ready_data/labor_dataset_splines_nochn_tmax_chn_prev_week_no_ll_0.dta"
...
foreach reg in $reg_list {
    ...
    * generate variables for the pooled regression to get the correct coeffs for LR group
	...
	if "`reg'" == "1_factor" {
	    local reg_treatment tmax_rcspl_3kn_t0_lr* tmax_rcspl_3kn_t1_lr* tmax_rcspl_3kn_t0_hr* tmax_rcspl_3kn_t1_hr*
	}
...
* -------------------------------------------------------------------------------------------------------
    * set the ster file name and the notes to be included
    local ster_name "`reg_folder'/interacted_reg_`reg'_2025_climatehigh_only.ster"
