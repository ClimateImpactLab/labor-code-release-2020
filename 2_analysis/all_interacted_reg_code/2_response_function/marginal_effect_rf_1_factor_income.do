...
foreach row_values in table_values {
	...
	foreach reg in $reg_list {
		...
		* set the ster file name and the output CSV
		local ster_name	"`reg_folder'/interacted_reg_1_factor__2026_272841_appro.ster"
		local rf_name 	"`rf_folder'/interacted_reg_`reg'_marg_`row_values'_2026_income_appro.csv"
