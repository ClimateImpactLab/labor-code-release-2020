...
foreach row_values in $table_values {
    ...
    foreach reg in $reg_list {
        ...
        local ster_name "`reg_folder'/interacted_reg_1_factor_2025_climatehigh_only.ster"
...
sort temp
local rf_name "`rf_folder'/interacted_reg_1_factor_2025_climatehigh_only_table.csv"
