...
prog def collect_polynomial_terms
	...
	forval degree=1(1)`order' {
		...
		gl `int'`degree' = 
			"_b[1.connmine#c.tmax_p`degree'] +" + 
			"_b[1.connmine#c.tmax_p`degree'_v1] +" + 
			"_b[1.connmine#c.tmax_p`degree'_v2] +" +
			"_b[1.connmine#c.tmax_p`degree'_v3] +" + 
			"_b[1.connmine#c.tmax_p`degree'_v4] +" +
			"_b[1.connmine#c.tmax_p`degree'_v5] +" +
			"_b[1.connmine#c.tmax_p`degree'_v6] "
		;
	...
	* collect the coefficients for each bin
	foreach bin in $`bins' {
		...
		* add prefix for numerical bins
		...
		gl `int'`bin' = 
			"_b[1.connmine#c.`coef'] +" + 
			"_b[1.connmine#c.`coef'_v1] +" + 
			"_b[1.connmine#c.`coef'_v2] +" + 
			"_b[1.connmine#c.`coef'_v3] +" + 
			"_b[1.connmine#c.`coef'_v4] +" + 
			"_b[1.connmine#c.`coef'_v5] +" + 
			"_b[1.connmine#c.`coef'_v6] "
		;
