...
run "${DIR_REPO_LABOR}/2_analysis/0_subroutines/function_test_agri.do"
...
foreach row_values in full_response table_values {
	...
	* set the ster file names and the output CSV
	local comm_ster		"`reg_folder'/uninteracted_reg_common_2025_agriandcomplement.ster"
	local by_risk_ster	"`reg_folder'/uninteracted_reg_by_risk_2025_agriandcomplement.ster"
	local rf_name 	"`rf_folder'/uninteracted_reg_comlohi_`row_values'_2025_agriandcomplement.csv"
