...
foreach row_values in full_response table_values {
    ...
    *Load the by_risk .ster
    local by_risk_ster "`reg_folder'/uninteracted_reg_by_risk_2025_manuf_noeu.ster"
    ...
    * 5) Export results
    local rf_name "`rf_folder'/uninteracted_reg_comlohi_`row_values'_2025_manu_noeu.csv"
